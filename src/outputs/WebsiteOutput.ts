...
export class WebsiteOutput extends AbstractDirectoryOutput<config> {
    ...
    protected async postProcess(mode: model): Promise<void> {
        await this.run(`npx tailwindcss -c ${__dirname}/../../assets/templates/default/tailwind.config.js -i ${__dirname}/../../assets/templates/default/styles.css.tailwind -o ./styles.css`)
    }
}
